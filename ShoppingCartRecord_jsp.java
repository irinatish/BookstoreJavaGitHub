...
//Database connection string
  ...
  public static String loadDriver1 () {
    String sErr = "";
    try {
      java.sql.DriverManager.registerDriver((java.sql.Driver)(Class.forName(stuff3).newInstance()));
    }
    catch (Exception e) {
      sErr = e.toString();
    }
  ...
  public static String loadDriver2 () {
    String sErr = "";
    try {
      java.sql.DriverManager.registerDriver((java.sql.Driver)(Class.forName(stuff3).newInstance()));
    }
  ...
  public static String loadDriver3 () {
    String sErr = "";
    try {
      java.sql.DriverManager.registerDriver((java.sql.Driver)(Class.forName(stuff5).newInstance()));
    }
    catch (Exception e) {
      sErr = e.toString();
    }
